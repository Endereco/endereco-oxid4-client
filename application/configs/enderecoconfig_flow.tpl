...
[{if
    ...
    <script async defer src="[{$oViewConf->getModuleUrl('endereco-oxid4-client', 'out/assets/js/endereco.min.js')}]?ver=[{$enderecoclient.sModuleVersion}]"></script>
    ...
    <script>
        var enderecoConfigureIntegrator = function() {
            window.EnderecoIntegrator.config.apiUrl = "[{$oViewConf->getModuleUrl('endereco-oxid4-client', 'proxy/io.php')}]";
